    ...
    try {
      ...
      const orderData = {
        items: carts.map(item => ({
          productId: item._id || null, // Assuming you might have _id from backend in future
  ...
  if(carts.length === 0) {
    return (
      <div className='h-[55vh] flex flex-col justify-center items-center'>
        <div className="text-4xl text-gray-800 font-semibold mb-4">Your Cart is Empty 🛒</div>
        <Link to="/products" className="text-indigo-600 hover:text-indigo-800 font-medium underline">
